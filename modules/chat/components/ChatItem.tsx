        ...
        >
          <motion.div
            className={clsx(
              ...
              condition
                ? "bg-neutral-300 dark:bg-[#1E1E1E] dark:text-neutral-50 author-gradient-border"
          ...
          >
            {isEditing ? (
              ...
              <>
                ...
                {is_reply && (
                  <>
                    <div className={clsx("text-xs text-neutral-600 dark:text-neutral-400 px-2 py-1 rounded-md mb-1 -mx-3", condition ? "bg-neutral-400 dark:bg-[#121212]" : "bg-neutral-300 dark:bg-[#121212]")}>
